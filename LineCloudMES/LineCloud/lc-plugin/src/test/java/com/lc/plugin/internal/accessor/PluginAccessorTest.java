...
public class PluginAccessorTest {
    ...
    public void shouldSynchronizePluginsFromClasspathAndDatabase() throws Exception {
        ...
        LineCloudPluginPlugin pluginsPlugin1 = mock(LineCloudPluginPlugin.class);
        ...
        LineCloudPluginPlugin pluginsPlugin21 = mock(LineCloudPluginPlugin.class);
        ...
        LineCloudPluginPlugin pluginsPlugin4 = mock(LineCloudPluginPlugin.class);
        ...
        Set<LineCloudPluginPlugin> pluginsFromDatabase = Sets.newHashSet(pluginsPlugin1, pluginsPlugin21, pluginsPlugin4);
    ...
    public void shouldListAllPlugins() throws Exception {
        ...
        LineCloudPluginPlugin pluginsPlugin1 = mock(LineCloudPluginPlugin.class, "plugin1");
        given(plugin1.getIdentifier()).willReturn("identifier1");
        given(pluginsPlugin1.getIdentifier()).willReturn("identifier1");
        given(pluginsPlugin1.getVersion()).willReturn("0.0.0");
        given(plugin1.compareVersion(new Version(pluginsPlugin1.getVersion()))).willReturn(0);
        ...
        LineCloudPluginPlugin pluginsPlugin21 = mock(LineCloudPluginPlugin.class, "plugin21");
        given(pluginsPlugin21.getIdentifier()).willReturn("identifier21");
        given(pluginsPlugin21.getState()).willReturn("ENABLED");
        ...
        LineCloudPluginPlugin pluginsPlugin3 = mock(LineCloudPluginPlugin.class, "plugin3");
        given(plugin3.getIdentifier()).willReturn("identifier3");
        ...
        Set<LineCloudPluginPlugin> pluginsFromDatabase = Sets.newHashSet(pluginsPlugin1, pluginsPlugin21, pluginsPlugin3);
    ...
    public void shouldFailOnPluginDowngrade() throws Exception {
        ...
        LineCloudPluginPlugin pluginsPlugin12 = mock(LineCloudPluginPlugin.class);
        ...
        Set<LineCloudPluginPlugin> pluginsFromDatabase = Sets.newHashSet(pluginsPlugin12);
    ...
    public void shouldPerformInit() throws Exception {
        ...
        LineCloudPluginPlugin pluginsPlugin2 = mock(LineCloudPluginPlugin.class, "plugin2");
        ...
        Set<LineCloudPluginPlugin> pluginsFromDatabase = Sets.newHashSet(pluginsPlugin1, pluginsPlugin2);
    ...
    public void shouldPerformEnableOnEnablingPlugins() throws Exception {
        ...
        LineCloudPluginPlugin pluginsPlugin2 = mock(LineCloudPluginPlugin.class);
        given(plugin2.getIdentifier()).willReturn("identifier2");
        given(pluginsPlugin2.getIdentifier()).willReturn("identifier2");
        ...
        InternalPlugin plugin3 = mock(InternalPlugin.class);
        LineCloudPluginPlugin pluginsPlugin3 = mock(LineCloudPluginPlugin.class);
        given(pluginsPlugin3.getIdentifier()).willReturn("identifier3");
        given(pluginsPlugin3.getVersion()).willReturn("0.0.0");
        ...
        Set<LineCloudPluginPlugin> pluginsFromDatabase = Sets.newHashSet(pluginsPlugin1, pluginsPlugin2, pluginsPlugin3);
        List<Plugin> sortedPluginsToInitialize = Lists.newArrayList((Plugin) plugin2, (Plugin) plugin1);
    ...
    public void shouldRemovePlugin() throws Exception {
        ...
        given(pluginDao.list()).willReturn(Sets.<LineCloudPluginPlugin> newHashSet(pluginsPlugin1, pluginsPlugin2));
    ...
    public void shouldSaveNewPlugin() throws Exception {
        ...
        given(pluginDao.list()).willReturn(Sets.<LineCloudPluginPlugin> newHashSet(pluginsPlugin1));
    ...
    public void shouldSaveExistingPlugin() throws Exception {
        ...
        given(pluginDao.list()).willReturn(Sets.<LineCloudPluginPlugin> newHashSet(pluginsPlugin2));
